...
class UserCrudCest
{
    ...
    // tests
    public function createUser(FunctionalTester $I, PostsPage $postsPage)
    {
    ...
    public function createUserValidationFails(FunctionalTester $I, PostsPage $postsPage)
    {
    ...
    public function editUser(FunctionalTester $I, PostsPage $postsPage)
    {
    ...
    public function deleteUser(FunctionalTester $I, PostsPage $postsPage)
    {
        $id = $I->haveRecord('posts', $this->postAttributes);
